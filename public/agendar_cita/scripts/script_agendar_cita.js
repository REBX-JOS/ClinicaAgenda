document.addEventListener('DOMContentLoaded', function () {
  ...
  .then(json => {
    ...
    // Si no hay sesión, bloquea y redirige
    if (!user) {
    ...
    inicializarAgendarCita(user);
  });

  // --- Lógica principal ---
  function inicializarAgendarCita(user) {
    ...
    bookBtn.addEventListener('click', async () => {
      ...
      confirmMsg.textContent = "Guardando cita..."; confirmMsg.style.display="block";
      try {
